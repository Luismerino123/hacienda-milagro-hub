...
export const Route = createFileRoute("/admin/salud")({ component: Page });
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Vacunas, tratamientos, visitas del veterinario y desparasitaciones.</p>
      </div>
