...
export const Route = createFileRoute("/admin/finanzas")({ component: Page });
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Ventas de leche, ventas de ganado, egresos y resúmenes.</p>
      </div>
