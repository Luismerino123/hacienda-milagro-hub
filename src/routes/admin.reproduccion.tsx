...
export const Route = createFileRoute("/admin/reproduccion")({ component: Page });
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Celos, montas, inseminaciones y partos.</p>
      </div>
