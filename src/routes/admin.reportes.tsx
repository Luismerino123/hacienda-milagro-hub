...
export const Route = createFileRoute("/admin/reportes")({ component: Page });
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        ...
        <p className="text-muted-foreground text-sm mt-1">Exportar inventario, producción, salud y finanzas a PDF/Excel.</p>
      </div>
