...
export const Route = createFileRoute("/admin/alertas")({ component: Page });

function Page() {
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        <h1 className="font-display text-3xl md:text-4xl">Alertas y recordatorios</h1>
        <p className="text-muted-foreground text-sm mt-1">Centro de notificaciones de la hacienda.</p>
      </div>
